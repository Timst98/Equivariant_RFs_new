...
RMSES=LogS=matrix(nrow=ntrain,ncol=5);Opt_par=list()
...
save(list = "res", file = paste0("learning_curves_chemical_opt_par_1000_random_swap_scalar", id, ".rda"))
